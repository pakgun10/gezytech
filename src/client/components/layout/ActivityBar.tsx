...
const ITEMS: ActivityBarItem[] = [
  // Default landing — "Agents" matches any path not claimed by a section below.
  {
    ...
    navigateTo: "/",
    icon: Home,
    labelKey: "activityBar.agents",
  },
  {
    matchPrefix: "/projects",
    navigateTo: "/projects",
    icon: FolderKanban,
    labelKey: "activityBar.projects",
  },
  {
    matchPrefix: "/books",
    navigateTo: "/books",
    icon: BookOpen,
    labelKey: "activityBar.books",
  },
  {
    matchPrefix: "/tasks",
    navigateTo: "/tasks",
  ...
  {
    matchPrefix: "/mini-apps",
    navigateTo: "/mini-apps",
    icon: Blocks,
    labelKey: "activityBar.apps",
  },
  {
    matchPrefix: "/models",
    navigateTo: "/models",
    icon: Boxes,
    labelKey: "activityBar.models",
    adminOnly: true,
  },
  {
...
export function ActivityBar() {
  ...
  function badgeFor(
    ...
    if (item.badgeKey === "tasks")
      return activeCount > 0
        ? { count: activeCount, warning: hasAwaiting }
        : null;
    if (item.badgeKey === "crons") {
      return pendingApprovalCount > 0
        ? { count: pendingApprovalCount, warning: true }
        : null;
    }
    return null;
  }
